...
for column in excel_data['Name'].tolist():
    ...
    try:
        ...
        # Version 0.2.2 Temporarily disables this for testing purposes
        # searchkeysconfirmation = wait.until(lambda driver: driver.find_element
        #                                      (by=By.XPATH, value='//*[@id="pane-side"]/div[1]/div/div/div[2]'))
        ...
        if validcontactcount == 1:
            firstavatar = wait.until(lambda driver: driver.find_element(by=By.XPATH,
                                                                        value='//*[@id="main"]/header'))
        ...
        if (validcontactcount % 2) == 1:
            try:
                firstavatar = driver.find_element(by=By.XPATH,
                                                  value='//*[@id="main"]/header/div[1]/div/img').get_attribute('src')
            except NoSuchElementException:
        ...
        if (validcontactcount % 2) == 0:
            try:
                secondavatar = driver.find_element(by=By.XPATH,
                                                   value='//*[@id="main"]/header/div[1]/div/img').get_attribute('src')
            except NoSuchElementException:
                secondavatar = 'null'
...
# Print amount of people contacted
# Also wait 60 Seconds before shutdown to send final messages
print("Cantidad de personas exitosamente convocadas:" + validcontactcount)
time.sleep(60)
